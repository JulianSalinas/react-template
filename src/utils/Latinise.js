...
/**
 * Removes all kind of accents and charactersd that are not present in the Latin alphabet
 * @param string Whatever string that could have accents or special characters
 * @returns {*|void}
 */
export function latinise(string) {
	return string.replace(/[^A-Za-z0-9]/g, function(x) { return latinMap[x] || x; });
}
